...
export const colors = {
  ink: '#16203C',        // was #16232E — now matches the logo exactly     // primary dark surface (headers, nav)
  inkLight:'#212C4D',   // lightened variant, same hue family // '#22364A',   // secondary dark surface (cards on dark)
  ...
  border: '#DCD9D0',
  danger: '#B23A3A',
  gold: '#E6B85C',       // sampled from the logo — use sparingly, as a brand accent
};
